...
export const Header = () => {
  ...
  const navItems = [
    { name: "Services", sub: ["Help and FAQs", "Order Tracking"] },
    { name: "About", sub: ["Our Team", "Mission"] },
    { name: "Contact Us", sub: ["Email", "Location", "Contact"] },
  ];
                      ...
                      <Link
                        ...
                        href={
                          item.name === "Contact Us"
                            ? `/${path}`
                            : `/${item.name.toLowerCase().replace(/\s+/g, "-")}/${path}`
                        }
                      >
                        {subItem}
                      </Link>
